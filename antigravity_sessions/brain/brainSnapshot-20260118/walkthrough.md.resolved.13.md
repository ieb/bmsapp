...
-   **State Management**: 
    -   Implemented [ServiceManager](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/service_manager.dart#8-94) to handle dynamic switching between BMS services (BLE, SeaSmart, Mock).
...
-   **Shared Preferences**: Created [PersistenceService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/persistence_service.dart#5-81) to save stats, logs, and settings across app restarts.
