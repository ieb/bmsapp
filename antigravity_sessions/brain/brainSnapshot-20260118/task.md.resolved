...
- [x] Implement History & Trends <!-- id: 33 -->
    ...
    - [x] Integrate [TrendsScreen](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/features/history/trends_screen.dart#9-15) into `DashboardScreen` <!-- id: 36 -->
...
- [x] Implement Stats Logic & Persistence <!-- id: 62 -->
    ...
    - [x] Create [PersistenceService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/persistence_service.dart#5-81) using `shared_preferences` <!-- id: 64 -->
    ...
    - [x] Add "Reset Statistics" functionality in [SettingsScreen](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/features/settings/settings_screen.dart#9-15) <!-- id: 67 -->
- [x] Implement Editable Protection Limits <!-- id: 68 -->
    ...
    - [x] Update [PersistenceService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/persistence_service.dart#5-81) to store protection limits & Dark Mode <!-- id: 70 -->
    - [x] Refactor [SettingsScreen](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/features/settings/settings_screen.dart#9-15) to use interactive input fields (TextFields) <!-- id: 71 -->
...
- [x] Implement Cloud Integration (Skeleton) <!-- id: 74 -->
    - [x] Create [CloudService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/cloud_service.dart#5-70) with basic API client (Dio/Http) <!-- id: 75 -->
    - [x] Implement [CloudSettings](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/features/settings/settings_screen.dart#82-91) (Enabled/Disabled, API Key, Endpoint) <!-- id: 76 -->
...
- [/] Finalize Cloud Protocol Implementation <!-- id: 79 -->
    ...
    - [ ] Update [CloudService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/cloud_service.dart#5-70) to send comprehensive battery state (Cells, Alerts) <!-- id: 82 -->
