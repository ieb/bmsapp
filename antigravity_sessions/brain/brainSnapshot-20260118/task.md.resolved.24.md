...
- [x] Refine History Screen Design <!-- id: 37 -->
    ...
    - [x] Implement [StatsGrid](bms_app/lib/features/dashboard/dashboard_screen.dart#215-284) (Total Charged/Load) <!-- id: 40 -->
...
- [ ] Refactor BLE Protocol <!-- id: 42 -->
    - [ ] Update [BmsData](bms_app/lib/core/models.dart#1-57) model with all JBD fields <!-- id: 43 -->
    - [ ] Update [BleBmsService](bms_app/lib/services/ble_service.dart#8-277) to parse full 0x03 packet <!-- id: 44 -->
