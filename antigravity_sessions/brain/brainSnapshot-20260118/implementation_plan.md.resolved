...
- Update [uploadTelemetry](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/cloud_service.dart#6-47) to use the refined JSON schema:
...
- Add `_keyDeviceId`.
- Implement `getOrCreateDeviceId()`: Generate a UUID using [Random](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#87-118) or similar if not present, then persist and return.

#### [MODIFY] [service_manager.dart](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/service_manager.dart)
- Fetch `deviceId` from [PersistenceService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/persistence_service.dart#5-81) on initialization.
...
- Add a `toJson()` helper to [BmsData](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/core/models.dart#1-140) to encapsulate protocol formatting logic.
