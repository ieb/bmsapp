...
- [ ] Implement Real Connectivity <!-- id: 27 -->
    - [ ] Create `ble_service.dart` (Scanning/Connecting) <!-- id: 28 -->
    - [ ] Create `seasmart_service.dart` (HTTP Polling) <!-- id: 29 -->
    - [ ] Update [ConnectionScreen](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/features/connection/connection_screen.dart#7-13) to use real services <!-- id: 30 -->
