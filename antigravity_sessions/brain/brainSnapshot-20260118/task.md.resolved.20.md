...
- [ ] Implement History & Trends <!-- id: 33 -->
    - [ ] Update [BmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#5-12) to store recent data points <!-- id: 34 -->
    - [ ] Create `TrendsScreen` with `fl_chart` <!-- id: 35 -->
    - [ ] Integrate `TrendsScreen` into [DashboardScreen](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/features/dashboard/dashboard_screen.dart#11-17) <!-- id: 36 -->
