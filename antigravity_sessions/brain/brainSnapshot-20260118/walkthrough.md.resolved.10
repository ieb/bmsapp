...
-   **Services**: 
    -   [BmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#5-15): Abstract base class. Supports **History buffering** (last 500 points).
    -   [BleBmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/ble_service.dart#8-330): **(UPDATED)** Full implementation of **JBD / Xiaoxiang BMS Protocol** (Service UUID: `0000ff00...`). 
    ...
    -   [SeaSmartService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/seasmart_service.dart#7-246): **(UPDATED)** Implemented **SeaSmart / NMEA 2000 Protocol**.
    -   [MockBmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#16-144): Available for testing.

### 2. **Screens**

#### **Connection Screen**
-   **HTTP**: "Connect via HTTP" button wires up [SeaSmartService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/seasmart_service.dart#7-246).
...
-   **Models**: Created [LogEntry](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/core/models.dart#125-142) and `LogSeverity` to track system notifications.
-   **Service Integration**: [BmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#5-15) now maintains a stream of events.
...
-   **Persistence**: Store logs and settings locally using `shared_preferences`.
