...
- [x] Implement History & Trends <!-- id: 33 -->
    - [x] Update [BmsService](bms_app/lib/services/bms_service.dart#5-15) to store recent data points <!-- id: 34 -->
...
- [x] Refactor BLE Protocol <!-- id: 42 -->
    ...
    - [x] Update [BleBmsService](bms_app/lib/services/ble_service.dart#8-330) to parse full 0x03 packet <!-- id: 44 -->
...
- [x] Implement Alerts & Event Log UI <!-- id: 52 -->
    - [x] Create [LogEntry](bms_app/lib/core/models.dart#125-142) and `LogSeverity` models <!-- id: 53 -->
    - [x] Update [BmsService](bms_app/lib/services/bms_service.dart#5-15) with logs stream & mock logic <!-- id: 54 -->
