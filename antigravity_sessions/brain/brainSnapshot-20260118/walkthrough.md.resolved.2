...
-   **Services**: 
    ...
    -   [BleBmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/ble_service.dart#8-271): **(UPDATED)** Implemented robust **JBD / Xiaoxiang BMS Protocol** (Service UUID: `0000ff00...`). 
    ...
    -   [SeaSmartService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/seasmart_service.dart#8-116): **(NEW)** Implemented generic HTTP polling logic structure.
...
-   **BLE**: "Scan & Connect BLE" shows a live list of Bluetooth devices. Clicking "Connect" pairs with the device using [BleBmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/ble_service.dart#8-271), discovers the JBD service, starts polling, and navigates to the Dashboard.
