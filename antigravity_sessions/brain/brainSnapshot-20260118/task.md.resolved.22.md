...
- [x] Implement History & Trends <!-- id: 33 -->
    ...
    - [x] Create [TrendsScreen](bms_app/lib/features/history/trends_screen.dart#8-14) with `fl_chart` <!-- id: 35 -->
    - [x] Integrate [TrendsScreen](bms_app/lib/features/history/trends_screen.dart#8-14) into [DashboardScreen](bms_app/lib/features/dashboard/dashboard_screen.dart#12-18) <!-- id: 36 -->
- [ ] Refine History Screen Design <!-- id: 37 -->
    - [ ] Update [TrendsScreen](bms_app/lib/features/history/trends_screen.dart#8-14) layout (Header, TimeSelector) <!-- id: 38 -->
    - [ ] Implement `LiveCurrentChart` with styling (Lime/Red colors, Grid) <!-- id: 39 -->
    - [ ] Implement [StatsGrid](bms_app/lib/features/dashboard/dashboard_screen.dart#215-284) (Total Charged/Load) <!-- id: 40 -->
