...
-   **Services**: 
    -   [BmsService](bms_app/lib/services/bms_service.dart#5-13): Abstract base class. Now supports **History buffering** (last 500 points).
...
#### **Connection Screen**
-   **HTTP**: "Connect via HTTP" button wires up [SeaSmartService](bms_app/lib/services/seasmart_service.dart#7-238) (currently transitions to Dashboard, assumes successful connection).
-   **BLE**: "Scan & Connect BLE" shows a live list of Bluetooth devices. Clicking "Connect" pairs with the device using [BleBmsService](bms_app/lib/services/ble_service.dart#8-277), discovers the JBD service, starts polling, and navigates to the Dashboard.
