...
-   **State Management**: 
    -   Implemented [ServiceManager](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/service_manager.dart#4-29) to handle dynamic switching between BMS services (BLE, SeaSmart, Mock).
...
-   **Services**: 
    -   [BmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#6-18): Abstract base class. Supports **History buffering** (last 500 points).
    -   [BleBmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/ble_service.dart#10-420): **(UPDATED)** Full implementation of **JBD / Xiaoxiang BMS Protocol** (Service UUID: `0000ff00...`). 
    ...
    -   [SeaSmartService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/seasmart_service.dart#9-336): **(UPDATED)** Implemented **SeaSmart / NMEA 2000 Protocol**.
    -   [MockBmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#19-227): Available for testing.

### 2. **Screens**

#### **Connection Screen**
-   **HTTP**: "Connect via HTTP" button wires up [SeaSmartService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/seasmart_service.dart#9-336).
...
-   **Models**: Created [LogEntry](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/core/models.dart#150-167) and `LogSeverity` to track system notifications.
-   **Service Integration**: [BmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#6-18) now maintains a stream of events.
...
-   **Shared Preferences**: Created [PersistenceService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/persistence_service.dart#5-69) to save stats, logs, and settings across app restarts.
-   **Maintenance Tools**: Added a "Reset Statistics" feature in the Settings screen with a safety confirmation dialog.
-   **Cross-Service Support**: Integrated persistence and Ah calculation into [MockBmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/bms_service.dart#19-227), [BleBmsService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/ble_service.dart#10-420), and [SeaSmartService](file:///Users/ieb/timefields/antigravity/bmsapp/bms_app/lib/services/seasmart_service.dart#9-336).
...
## Verification
-   **Browser Subagent**: Verified settings persist across navigation and generate log entries.
-   **Dark Mode**: Confirmed theme toggle updates the system and persists via `SharedPreferences`.

## Next Steps
-   **Cloud Integration**: Implement real API endpoints for remote monitoring.
