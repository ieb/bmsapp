...
- [x] Implement History & Trends <!-- id: 33 -->
    - [x] Update [BmsService](bms_app/lib/services/bms_service.dart#6-17) to store recent data points <!-- id: 34 -->
    - [x] Create [TrendsScreen](bms_app/lib/features/history/trends_screen.dart#9-15) with `fl_chart` <!-- id: 35 -->
    - [x] Integrate [TrendsScreen](bms_app/lib/features/history/trends_screen.dart#9-15) into [DashboardScreen](bms_app/lib/features/dashboard/dashboard_screen.dart#13-19) <!-- id: 36 -->
...
- [x] Refactor BLE Protocol <!-- id: 42 -->
    - [x] Update [BmsData](bms_app/lib/core/models.dart#1-125) model with all JBD fields <!-- id: 43 -->
    - [x] Update [BleBmsService](bms_app/lib/services/ble_service.dart#10-393) to parse full 0x03 packet <!-- id: 44 -->
...
- [x] Implement Alerts & Event Log UI <!-- id: 52 -->
    - [x] Create [LogEntry](bms_app/lib/core/models.dart#135-152) and `LogSeverity` models <!-- id: 53 -->
    - [x] Update [BmsService](bms_app/lib/services/bms_service.dart#6-17) with logs stream & mock logic <!-- id: 54 -->
    - [x] Implement [AlertsScreen](bms_app/lib/features/alerts/alerts_screen.dart#7-13) with ڈیزائن-matching styling <!-- id: 55 -->
    - [x] Integrate [AlertsScreen](bms_app/lib/features/alerts/alerts_screen.dart#7-13) into navigation tabs <!-- id: 56 -->
...
- [x] Implement Stats Logic & Persistence <!-- id: 62 -->
    - [x] Update [BmsData](bms_app/lib/core/models.dart#1-125) with `totalChargedAh` and `totalDischargedAh` <!-- id: 63 -->
    - [x] Create [PersistenceService](bms_app/lib/services/persistence_service.dart#5-52) using `shared_preferences` <!-- id: 64 -->
    ...
    - [x] Add "Reset Statistics" functionality in [SettingsScreen](bms_app/lib/features/settings/settings_screen.dart#7-109) <!-- id: 67 -->
- [/] Implement Editable Protection Limits <!-- id: 68 -->
    - [ ] Add `updateSettings` methods to [BmsService](bms_app/lib/services/bms_service.dart#6-17) and implementations <!-- id: 69 -->
    - [ ] Update [PersistenceService](bms_app/lib/services/persistence_service.dart#5-52) to store protection limits <!-- id: 70 -->
    - [ ] Refactor [SettingsScreen](bms_app/lib/features/settings/settings_screen.dart#7-109) to use interactive input fields (TextFields/Sliders) <!-- id: 71 -->
